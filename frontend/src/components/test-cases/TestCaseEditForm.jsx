          ...
          <div className="flex space-x-1" data-element="test-case-edit-tabs-list">
            {tabs.map(tab => (
              <button
                ...
                `}
                data-element={`test-case-edit-tab-${tab.id}`}
              ...
              <div className="flex items-center gap-3" data-element="test-case-basic-info-header">
                ...
                <div>
                  ...
                  <p className="text-sm text-apple-gray-5" data-element="test-case-basic-info-subtitle">
                    Core details and content for the test case
                  </p>
                </div>
              </div>
            </Card.Header>
          ...
          <Card elevation="lg" className="border-l-4 border-l-info" data-element="test-case-metadata-card">
            <Card.Header>
              <div className="flex items-center gap-3" data-element="test-case-metadata-header">
                ...
                <div>
                  <h3 className="text-xl font-sf font-bold text-apple-gray-7" data-element="test-case-metadata-title">
                    Configuration & Metadata
                  </h3>
                  <p className="text-sm text-apple-gray-5" data-element="test-case-metadata-subtitle">
                    Priority, importance, execution settings, and organizational details
                  </p>
                </div>
              </div>
            </Card.Header>
            <Card.Body data-element="test-case-metadata-content">
              <div className="space-y-6" data-element="test-case-metadata-fields">
